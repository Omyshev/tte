(function() {
    ...
    function addYoutubeButton() {
        let menu = $('.menu .menu__list'); // Находим контейнер меню

        if (!menu.length) {
            console.error("Меню Lampa не найдено!");
            return;
        }

        let youtubeButton = $('<li class="menu__item selector focus" data-action="youtube">')
            .append('<div class="menu__ico"><img src="https://www.youtube.com/s/desktop/9b235b1d/img/favicon.ico"></div>')
